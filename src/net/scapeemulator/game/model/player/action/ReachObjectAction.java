...
public abstract class ReachObjectAction extends ReachDistancedAction {
    ...
    public ReachObjectAction(int delay, boolean immediate, Player player, GroundObject object, int distance) {
        super(delay, immediate, player, object.getBounds(), distance);
        this.object = object;
    }
