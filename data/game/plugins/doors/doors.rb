...
module RuneEmulator
	class Doors
		...
		class ObjectProxy
			...
			def register()
				if @target == nil
					@target = OBJECT_LIST.put(@position, @id, @rotation, @type, true)
					@target.hide
				end
			end
		...
		class DoorData
			...
			def get_object(origin, orientation, type)
				...
				if OBJECT_LIST.contains(object_id, position)
					...
					args = { :id => object_id, :position => position, :rotation => orientation[type][:rotation], :type => ObjectType::STRAIGHT_WALL }
					ObjectProxy.new(args)
				end
			end
...
RuneEmulator::Doors.bind_door(1534, 1533)
RuneEmulator::Doors.bind_door(8696, 8695)
RuneEmulator::Doors.bind_door(11708, 11707)
RuneEmulator::Doors.bind_door(11715, 11714)
...
RuneEmulator::Doors.bind_door(40109, 40108)
RuneEmulator::Doors.bind_double_door(34820, 34823, 34819, 34822)
RuneEmulator::Doors.bind_double_door(37000, 37003, 36999, 37002)
RuneEmulator::Doors.bind_gate(7051, 7052, 7049, 7050)
RuneEmulator::Doors.bind_gate(36912, 36914, 36913, 36915)
RuneEmulator::Doors.bind_gate(36918, 36916, 36917, 36919)
