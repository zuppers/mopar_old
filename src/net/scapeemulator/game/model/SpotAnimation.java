...
/**
 * Represents a certain Animation with an Id, delay and height.
 * All its attributes are immutable.
 * 
 */
public final class SpotAnimation {
	...
	private final int id, delay, height;
        ...
        /**
         * Creates a {@link SpotAnimation} with the provided id, 0 delay and 0 height.
